          ...
          <div className="flex items-center space-x-4">
            {isAuthenticationChecked && (
              userData ? (
                <>
                  <Link href="/orders">
                    <span className="text-3xl mb-2 relative">
                      <FaShoppingCart />
                      {orderCount > 0 && (
                        <span className="absolute top-0 right-0 bg-red-500 text-gray-200 rounded-full w-4 h-4 text-[10px] flex items-center justify-center">
                          {orderCount}
                        </span>
                      )}
                    </span>
