    ...
    return (
        <div className="fixed inset-0 flex justify-center items-center bg-opacity-60 bg-gray-800 backdrop-blur z-50">
            <div className="bg-white p-8 rounded-2xl shadow-md w-96 relative">
                ...
                <h1 className="text-2xl font-bold text-center">Tokobaru</h1>
                <h2 className="text-m text-center mb-3">Create an account</h2>
                <form onSubmit={handleRegister}>
                    ...
                    <div className="mb-6 mt-2">
                        <label htmlFor="avatar" className="cursor-pointer flex justify-center space-x-2 mt-1 border-dashed border-2 rounded-xl p-2">
                            <FaUpload />
